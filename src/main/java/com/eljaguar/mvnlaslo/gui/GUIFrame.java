...
public class GUIFrame extends javax.swing.JFrame {
    ...
    private javax.swing.JCheckBoxMenuItem jCBMIEnglish;
    private javax.swing.JCheckBoxMenuItem jCBMISpanish;
    ...
    public GUIFrame() throws IOException {
        ...
        if (!checkExternalFiles()) {
            MessageBox.showInformationBox("Missing external executables, check the EXT folder.", "ERROR");
            System.exit(0b1);
        }
    }
    ...
    private void initComponents() {
        ...
        JButton jSetProxy = new JButton();
        JMenuBar jMenuBar1 = new JMenuBar();
        jMenuFile = new javax.swing.JMenu();
        jMIExit = new javax.swing.JMenuItem();
        jMenuHelp = new javax.swing.JMenu();
        jMenuLanguage = new javax.swing.JMenu();
        jCBMIEnglish = new javax.swing.JCheckBoxMenuItem();
        jCBMISpanish = new javax.swing.JCheckBoxMenuItem();
        jMIAbout = new javax.swing.JMenuItem();

        setDefaultCloseOperation(javax.swing.WindowConstants.DO_NOTHING_ON_CLOSE);
        setTitle("Find-A-Loop");
        String fontFamily = "Calibri";
        setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        setIconImage(new ImageIcon(Objects.requireNonNull(getClass().getResource("/noun_DNA_1088243.png"))).getImage());
        ...
        jcbMakeRandoms.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        //java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("Bundle"); // NOI18N
        jcbMakeRandoms.setText(bundle.getString("RANDOMIZE_CHECK")); // NOI18N
        jcbMakeRandoms.addActionListener(this::jcbMakeRandomsActionPerformed);

        jcbExtended.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        jcbExtended.setText(bundle.getString("EXTENDED_MODE_CHECK")); // NOI18N
        jcbExtended.addActionListener(this::jcbExtendedActionPerformed);

        jLblNRand.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        ...
        jLblNKlet.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        ...
        jftkLet.addActionListener(this::jftkLetActionPerformed);

        jLblDestiny.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        jLblDestiny.setText(bundle.getString("DESTINATION")); // NOI18N

        jTFPathOut.setEditable(false);
        jTFPathOut.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        ...
        jTFPathOut.addActionListener(this::jTFPathOutActionPerformed);

        jButtonOut.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/noun_53223_cc.png")))); // NOI18N
        jButtonOut.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jButtonOut.setSelectedIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/noun_53223_cc.png")))); // NOI18N
        jButtonOut.addActionListener(evt -> jButtonOutActionPerformed());

        jLabel1.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        jLabel1.setText(bundle.getString("TEMPERATURE")); // NOI18N

        jsTemperature.setPreferredSize(new java.awt.Dimension(45, 22));
        jsTemperature.addChangeListener(this::jsTemperatureStateChanged);

        jcbAvoidLonePairs.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        jcbAvoidLonePairs.setSelected(true);
        jcbAvoidLonePairs.setText(bundle.getString("AVOID_PAIRS")); // NOI18N
        jcbAvoidLonePairs.addActionListener(this::jcbAvoidLonePairsActionPerformed);
        ...
        jLblStemBetween.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        ...
        jSpinMinLength.addChangeListener(this::jSpinMinLengthStateChanged);
        ...
        jSpinMaxLength.addChangeListener(this::jSpinMaxLengthStateChanged);

        jLblWoobles.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        jLblWoobles.setText(bundle.getString("WOOBLE_ALLOWED_TO")); // NOI18N

        jSpinWooble.setPreferredSize(new java.awt.Dimension(35, 22));
        jSpinWooble.addChangeListener(evt -> jSpinWoobleStateChanged());

        jLblMismatchs.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        ...
        jSpinMismatch.addChangeListener(this::jSpinMismatchStateChanged);

        jLblInput.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        jLblInput.setText(bundle.getString("ENTER_THE_LOOPS")); // NOI18N

        jcbSearchInverse.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        jcbSearchInverse.setText(bundle.getString("INVERSE_PATTERN")); // NOI18N
        jcbSearchInverse.setActionCommand("");
        jcbSearchInverse.addActionListener(this::jcbSearchInverseActionPerformed);

        jTALoopPatterns.setColumns(20);
        String fontFamilyLight = "Calibri Light";
        jTALoopPatterns.setFont(new java.awt.Font(fontFamilyLight, Font.PLAIN, 12)); // NOI18N
        ...
        jftAdditionalSeq.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        jftAdditionalSeq.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        jftAdditionalSeq.setVerifyInputWhenFocusTarget(false);
        jftAdditionalSeq.addActionListener(this::jftAdditionalSeqActionPerformed);

        jlSingleSequence.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        ...
        jPanOptionsLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, jSpinMaxLength, jSpinMinLength);
        ...
        jBtnStart.addActionListener(evt -> jBtnStartActionPerformed());

        jTAConsole.setEditable(false);
        jTAConsole.setBackground(new java.awt.Color(51, 51, 51));
        jTAConsole.setColumns(20);
        jTAConsole.setFont(new java.awt.Font("Consolas", Font.PLAIN, 13)); // NOI18N
        ...
        jLblError.setFont(new java.awt.Font(fontFamily, Font.ITALIC, 14)); // NOI18N
        ...
        jBtnStop.addActionListener(this::jBtnStopActionPerformed);
        ...
        jTabInput.addChangeListener(this::jTabInputStateChanged);

        jLabel4.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        jLabel4.setText(bundle.getString("PATH")); // NOI18N

        jTFPathIn.setEditable(false);
        jTFPathIn.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        ...
        jTFPathIn.addActionListener(evt -> jTFPathInActionPerformed());

        jButtonIn.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/noun_53223_cc.png")))); // NOI18N
        jButtonIn.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jButtonIn.addActionListener(evt -> jButtonInActionPerformed());

        jLabel7.setFont(new java.awt.Font(fontFamilyLight, Font.PLAIN, 12)); // NOI18N
        ...
        jTAGenes.setFont(new java.awt.Font(fontFamilyLight, Font.PLAIN, 12)); // NOI18N
        jTAGenes.setRows(5);
        jScrollPane3.setViewportView(jTAGenes);

        jrbNcbi.setFont(new java.awt.Font(fontFamily, Font.PLAIN, 12)); // NOI18N
        jrbNcbi.setSelected(true);
        jrbNcbi.setText("NCBI");

        jLabel8.setFont(new java.awt.Font(fontFamilyLight, Font.PLAIN, 12)); // NOI18N
        jLabel8.setText(bundle.getString("NCBI_DESC")); // NOI18N

        jSetProxy.setText(bundle.getString("SETPROXY")); // NOI18N
        jSetProxy.addActionListener(this::jSetProxyActionPerformed);
        ...
        jCBMIEnglish.setSelected(true);
        jCBMIEnglish.setText("English");
        jCBMIEnglish.addActionListener(this::jCBMIEnglishActionPerformed);
        jMenuLanguage.add(jCBMIEnglish);

        jCBMISpanish.setText("Español");
        jCBMISpanish.addActionListener(this::jCBMISpanishActionPerformed);
        jMenuLanguage.add(jCBMISpanish);
    ...
    private void jSpinWoobleStateChanged() {//GEN-FIRST:event_jSpinWoobleStateChanged
    ...
    private void jButtonInActionPerformed() {//GEN-FIRST:event_jButtonInActionPerformed
    ...
    private void jCBMIEnglishActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCBMI_EnglishActionPerformed
        ...
        if (this.jCBMIEnglish.isSelected()) {
            ...
            this.jCBMISpanish.setSelected(true);
        }
     ...
     * @return
     */
    public boolean validateParameters(int min, int max, int wobble,
                                      int mismatch, String pathIn, String pathOut,
                                      List<String> loopList, List<String> geneList,
        ...
        // Validate numbers
        if (min > max || wobble > max || mismatch > max
                || min < 3 || wobble < 0 || mismatch < 0) {
            this.jLblError.setText(bundle.getString("ERROR_PARAM"));
            MessageBox.showInformationBox(bundle.getString("ERROR_PARAM"), "Error");
            isValid = false;
        }
        ...
        if (jTabInput.getSelectedIndex() == 1) {
            if (!netIsAvailable()) {
                ...
                MessageBox.showInformationBox(bundle.getString("NO_NET_CONNECTION"), "Error");
                return isValid;
            }
            ...
            for (int i = 0; i < geneList.size() && isValid; i++) {
                ...
                if (aux.length() <= 0) {
                    ...
                    MessageBox.showInformationBox(bundle.getString("ERROR_CHECK_GENES"), "Error");
                    return isValid;
                }
            }
            ...
            if (!new File(pathIn).exists()) {
                ...
                MessageBox.showInformationBox(bundle.getString("ERROR_SOURCE"), "Error");
                isValid = false;
            }
        }
        ...
        if (!new File(pathOut).exists()) {
            ...
            MessageBox.showInformationBox(bundle.getString("ERROR_DEST_FOLDER"), "Error");
            isValid = false;
        }

        if (loopList.isEmpty() || loopList.get(0).trim().length() == 0) {
            this.jLblError.setText(bundle.getString("ERROR_LOOPS"));
            MessageBox.showInformationBox(bundle.getString("ERROR_LOOPS"), "Error");
            isValid = false;
        }
        ...
        for (int i = 0; i < loopList.size() && isValid; i++) {
            ...
            if (aux.length() <= 0) {
                ...
                MessageBox.showInformationBox(bundle.getString("ERROR_CHECK_LOOPS"), "Error");
            }
        }
        ...
        if (this.jcbMakeRandoms.isSelected()) {
            if (randoms <= 0) {
                ...
                MessageBox.showInformationBox(bundle.getString("ERROR_INVALID_NBR_RANDOMS"), "Error");
                isValid = false;
            }
        }

        if (this.jcbMakeRandoms.isSelected() && klet <= 0 || klet > 10) {
            this.jLblError.setText(bundle.getString("ERROR_INVALID_NBR_RANDOMS"));
            MessageBox.showInformationBox(bundle.getString("ERROR_INVALID_NBR_RANDOMS"), "Error");
            isValid = false;
        }
    ...
    public void start() {
        ...
        // Loops
        loopList = new ArrayList<>(asList(loops));
        ...
        loopMatcher.setMaxWobble(wooble);
